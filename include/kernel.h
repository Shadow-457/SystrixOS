...
/* Special key codes returned by keyboard drivers */
#define KEY_UP    0x80
...
/* ================================================================
 *  DRIVER DECLARATIONS (drivers/ folder)
 *  Only declarations NOT already present in kernel.h above.
 * ================================================================ */
...
typedef struct { u16 raw[256]; } ata_identity_t;
