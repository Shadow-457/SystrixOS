...
/* Print a digit 0-9.
 * MUST use a static buffer — a stack-local char whose address is
 * passed to write() can be clobbered before the syscall completes
 * under -O2 -mno-red-zone, printing garbage instead of the digit. */
