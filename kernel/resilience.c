...
#define WD_TIMEOUT_MS  30000  /* 30 seconds — TCG emulation is slow */
...
void watchdog_init(void) {
    wd_counter   = 0;
    wd_suspended = 0;
    wd_enabled   = 0;   /* disabled — TCG emulation too slow for watchdog */
    print_str("[WD] Watchdog disabled (TCG mode)\r\n");
}
